...
namespace XamaRing.Controls
{
    public class DatePickerButton : Button
    {
        ...
        public static readonly BindableProperty DateProperty =
            BindableProperty.Create<DatePickerButton, DateTime?>(p => p.Date, null, defaultBindingMode: BindingMode.TwoWay);
        ...
        public static readonly BindableProperty TextFormatProperty =
            BindableProperty.Create<DatePickerButton, string>(p => p.TextFormat, "dd'/'MM'/'yyyy");
